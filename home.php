...
$sqlget = 'SELECT * FROM listallplayers ';
...
?>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 style = "margin-top: 70px">Tableau de bord</h1>
     	  <p class="page-header">Panneau d'aministration.</p>
<?php
    //Max players
    echo '
    <div class="row">
    ...
    echo        "<div class='box-top'><center><h1>Joueurs</h1></div>";
    echo        "<div class='box-panel'><p></p>";
    echo        '<p><br><center>Il y a actuellement '.$listallplayers .' de joueurs en db</p>';
    echo        '</div>';
    echo    '</div>';
    ...
    echo        "<div class='box-top'><center><h1>Véhicles</h1></div>";
    echo        "<div class='box-panel'><p></p>";
    echo        '<p><br><center>Il y a actuellement '.$vehicles.' véhicles.</p>';
    echo        '</div>';
    echo    '</div>';
...
$money = '$'.number_format($money, 2);
    ...
    echo        "<div class='box-panel'><p></p>";
    echo        '<p><br><center>Le total cumulué d argent des joueurs est de :  '.$money.'</p>';
    echo        '</div>';
    echo    '</div>';
    ...
    echo        "<div class='box-top'><center><h4>Aide concernant le panel du bon staff !</h4></div>";
    echo        "<div class='box-panel'><p></p>";
    echo            '<form action=home.php method=post>';
...
<div class ="headD"><center><h3>Donate to see further updates!<h3></center></div>
	...
	<input type="image" src="https://locahost" border="0" name="submit" alt="PayPal – The safer, easier way to pay online.">
	<img alt="" border="0" src="https://locahost" width="1" height="1">
	</form></div>
</div> -->
