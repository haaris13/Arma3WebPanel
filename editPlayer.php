...
$sql = "SELECT * FROM `listallplayers` WHERE uid = '$uidPlayer'";
...
?>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 style = "margin-top: 70px">Modifier le joueur</h1>
		  <p class="page-header">Le menu Edit player vous permet de changer certaine information des joueurs.</p>
          <div id="alert-area"></div>
		  <form action='editPlayer.php' method='post'>
		  <div class="btn-group" role="group" aria-label="...">
		  <input class = 'btn-outlineeffacertoutelesciv' type='submit' name='remove' value='Effacer toutes les Licenses civile'>
	   	  </div>
          <div class="btn-group" role="group" aria-label="...">
          <input class = 'btn btn-primary btn-outline' type='submit' name='give' value='Donner toutes les licences !'>
          </div>
          <input type=hidden name=hidden value= <?php echo $uidPlayer; ?> >
          <input type=hidden name=guid value= <?php echo $guidPlayer; ?> >
          <div class="btn-group" role="group" aria-label="...">
          <button type="button" class="btn btn-primary btn-outline" data-toggle="modal" data-target="#myModal">Invetaire du joueur</button>
          </form>
    </div>
          <br>
...
<div class="modal-dialog modal-lg">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title" id="myModalLabel">Invetaire du joueur</h4>
    </div>
...
<div class='panel panel-info'>
  <div class='panel-heading'>
    <h3 class='panel-title'>Information du joueur</h3>
  </div>
  <div class='panel-body'>
<?php
echo "<div class='lic'>";
...
echo "<div class='panel panel-info'>
  <div class='panel-heading'>
    <h3 class='panel-title'>Editer</h3>
  </div>
  <div class='panel-body'>";
...
$sqlget = "SELECT * FROM listallplayers WHERE uid='$uidPlayer';";
...
echo "<div class='panel panel-info'>
  <div class='panel-heading'>
    <h3 class='panel-title'>Note sur le joueur</h3>
  </div>
  <div class='panel-body'>";
  ?>
            <div class="table-responsive">
...
if (isset($_POST['remove'])) {
    if ($staffPerms['editPlayer'] == '1') {
        ...
        $sql = "UPDATE `listallplayers` SET `civ_licenses`='$licReset' WHERE uid ='$uidPlayer'";
        $result = mysqli_query($dbcon, $sql);
