...
<nav class="navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <div class="navbar-brand"><a>Staff <span>Pacific Island</span></a></div>

        </div>
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="home.php" style="color: #fff">Dashboard</a></li>
                <li><a href="settings.php" style="color: #fff">Paramètre</a></li>
                <li><a href="profile.php" style="color: #fff">Profile</a></li>
                <li><a href="help.php" style="color: #fff">Aide</a></li>
            </ul>
        </div>
    </div>
</nav>
            ...
            <ul class="nav nav-sidebar">
                ...
                switch ($staffPerms) {
                    case $staffPerms['vehicles'] == '1':
                        echo "<li><a href=\"vehicles.php\">Véhicules</a></li>";
                    case $staffPerms['gangs'] == '1':
                        echo "<li><a href=\"gangs.php\">Gangs</a></li>";
                    case $staffPerms['housing'] == '1':
                        echo "<li><a href=\"houses.php\">Maisons</a></li>";
                                                                                    case $staffPerms['logs'] == '1':
                                                                                        echo "<li><a href=\"logs.php?page=1\">logs</a></li>";
                 case $staffPerms['logs'] == '1':
                            echo "<li><a href=\"cheat.php?page=1\">Cheat Logs</a></li>";
                    case $staffPerms['money'] == '1':
                        echo "<li><a href=\"reimbursement.php\">Logs rembourssement</a></li>";
                    ...
                    case $staffPerms['steamView'] == '1':
                        echo "<li><a href=\"steam.php\">Compte Steam</a></li>";
                }
                ?>
