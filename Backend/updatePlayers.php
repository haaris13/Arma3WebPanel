...
$sql = "SELECT * FROM `listallplayers` WHERE `uid` = $_POST[uid]";
...
switch ($_POST['column']) {
    case 'cash':
        ...
        $UpdateQ = "UPDATE listallplayers SET $_POST[column]='$cash' WHERE uid='$_POST[uid]'";
    break;
    case 'bankacc':
        $bankacc = logs($staffPerms['money'], 'bankacc', $pid, $user, $dbcon, $player, $_POST['editval']);
        $UpdateQ = "UPDATE listallplayers SET $_POST[column]='$bankacc' WHERE uid='$_POST[uid]'";
    break;
    case 'coplevel':
        $coplevel = logs($staffPerms['cop'], 'coplevel', $pid, $user, $dbcon, $player, $_POST['editval']);
        $UpdateQ = "UPDATE listallplayers SET $_POST[column]='$coplevel' WHERE uid='$_POST[uid]'";
    break;
    case 'mediclevel':
        $mediclevel = logs($staffPerms['medic'], 'mediclevel', $pid, $user, $dbcon, $player, $_POST['editval']);
        $UpdateQ = "UPDATE listallplayers SET $_POST[column]='$mediclevel' WHERE uid='$_POST[uid]'";
    break;
    case 'adminlevel':
        $adminlevel = logs($staffPerms['IG-Admin'], 'adminlevel', $pid, $user, $dbcon, $player, $_POST['editval']);
        $UpdateQ = "UPDATE listallplayers SET $_POST[column]='$adminlevel' WHERE uid='$_POST[uid]'";
    break;
    case 'donatorlvl':
        $donatorlvl = logs($staffPerms['editPlayer'], $_POST['column'], $pid, $user, $dbcon, $player, $_POST['editval']);
        $UpdateQ = "UPDATE listallplayers SET $_POST[column]='$donatorlvl' WHERE uid='$_POST[uid]'";
    break;
    case 'donorlevel':
        $donorlevel = logs($staffPerms['editPlayer'], $_POST['column'], $pid, $user, $dbcon, $player, $_POST['editval']);
        $UpdateQ = "UPDATE listallplayers SET $_POST[column]='$donorlevel' WHERE uid='$_POST[uid]'";
    break;
    case 'blacklist':
        $blacklist = logs($staffPerms['editPlayer'], $_POST['column'], $pid, $user, $dbcon, $player, $_POST['editval']);
        $UpdateQ = "UPDATE listallplayers SET $_POST[column]='$blacklist' WHERE uid='$_POST[uid]'";
    break;
