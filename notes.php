...
<h1 style = "margin-top: 70px">Notes & Observations</h1>
<p class="page-header">Ajouter une note ou une observation sur un joueur.</p>
...
if (isset($_POST['update'])) {
    $sql = "SELECT * FROM `listallplayers` WHERE `uid` = $_POST[hidden]";
